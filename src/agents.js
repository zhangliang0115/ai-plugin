...
export const AGENTS = [
  ...
  },
  {
    ...
    tier: 'official',
    note: 'official docs also read ~/.agents/skills and .claude/skills',
  },
  {
    id: 'openclaw',
    label: 'OpenClaw',
    ...
    configDirs: ['~/.openclaw'],
    tier: 'official',
    note: 'official docs read ~/.agents/skills by default (workspace .agents/skills ranks higher)',
  },
  {
    id: 'reasonix',
    ...
    configDirs: ['~/.reasonix'],
    tier: 'official',
    note: 'reads .agents/skills convention dirs natively (source: internal/config/paths.go); ~/.reasonix/skills ranks higher',
  },
]
