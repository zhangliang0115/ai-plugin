		...
		function HubConsole() {
			...
			return (0, h)("div", { className: "apxdsh-root" },
				...
				consoleEnabled && bridgeReady
					? (0, h)(react.Fragment, null,
						(0, h)("nav", { className: "apxdsh-subnav", role: "tablist" },
							HUB_TABS.map(([id, label]) => (0, h)("button", {
								key: id,
								type: "button",
								role: "tab",
								className: "apxdsh-subnavBtn" + (tab === id ? " apxdsh-subnavActive" : ""),
								onClick: () => { setTab(id); }
							}, label))
						),
