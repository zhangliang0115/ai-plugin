			...
			return (0, h)("div", { className: "apxdsh-root" },
				...
				consoleEnabled && bridgeReady
					? (0, h)("div", { className: "apxdsh-grid" },
						(0, h)("div", { className: "apxdsh-span" }, (0, h)(ServersSection, { data: data, onRefresh: refresh })),
						(0, h)(EngineSection, { data: data, onRefresh: refresh }),
						(0, h)(ModelToolsSection, { data: data }),
						(0, h)("div", { className: "apxdsh-span" }, (0, h)(ToolsSection, { data: data, onRefresh: refresh })),
						(0, h)("div", { className: "apxdsh-span" }, (0, h)(SearchSection, null))
					)
					: null
			);
		}
