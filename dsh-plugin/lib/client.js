		...
		function PluginSettingsSection() {
			...
			return (0, h)("section", { className: "apxdsh-section" },
				...
				(0, h)("div", { className: "apxdsh-form" },
					...
					(0, h)(SwitchRow, {
						label: "全屏显示",
						hint: "开启后「工具中枢」面板铺满整个屏幕（不再局限在设置小窗）；关闭则恢复小窗",
