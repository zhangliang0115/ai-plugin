...
onChange: (event) => { setName(event.target.value); setOverwriteOk(false); }
		...
		*/
		...
		function HubConsole() {
			...
			const HUB_TABS = [["mcp", "MCP 服务器"], ["tools", "工具目录"], ["search", "搜索引擎"], ["models", "模型工具"], ["settings", "插件设置"]];
			return (0, h)("div", { className: "apxdsh-root" },
				...
				consoleEnabled && bridgeReady
					? (0, h)("div", { className: "apxdsh-layout" },
						(0, h)("nav", { className: "apxdsh-rail", role: "tablist", "aria-label": "工具中枢" },
							HUB_TABS.map(([id, label]) => (0, h)("button", {
								key: id,
								type: "button",
								role: "tab",
								className: "apxdsh-railBtn" + (tab === id ? " apxdsh-railActive" : ""),
								onClick: () => { setTab(id); }
							}, label))
						),
						(0, h)("div", { className: "apxdsh-volume" },
							tab === "mcp" ? (0, h)("div", { className: "apxdsh-grid" }, (0, h)("div", { className: "apxdsh-span" }, (0, h)(ServersSection, { data: data, onRefresh: refresh }))) : null,
							tab === "tools" ? (0, h)(ToolsSection, { data: data, onRefresh: refresh }) : null,
							tab === "search" ? (0, h)(react.Fragment, null, (0, h)(EngineSection, { data: data, onRefresh: refresh }), (0, h)(SearchSection, null)) : null,
							tab === "models" ? (0, h)(ModelToolsSection, { data: data }) : null,
							tab === "settings" ? (0, h)(PluginSettingsSection, null) : null
						)
					)
					: null
			);
